      ...
      <div className={styles.inner}>
        <div className={styles.col}>
          ...
          <p className={styles.about}>
            Tienda especializada en celulares, accesorios y consolas. Recibimos usados y
            coordinamos entregas a todo el pais.
          </p>
        ...
        <div className={styles.col}>
          ...
          <ul className={styles.list}>
            <li>
              <FaWhatsapp />
              <a href="https://wa.me/5493537673531" target="_blank" rel="noopener noreferrer">
                +54 9 3537 67-3531
              </a>
            </li>
            <li>
              <span>◉</span> Bell Ville, Cordoba
            </li>
          </ul>
        </div>
        ...
        <div className={styles.col}>
          ...
          <div className={styles.social}>
            ...
            <a
              href="https://www.instagram.com/iphoneselectbv?igsh=MW1kaXdlbG5ncWh6dQ=="
              target="_blank"
              rel="noopener noreferrer"
